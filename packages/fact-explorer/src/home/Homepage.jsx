...
// destination. Only /fact-explorer/<app> is "Fact Explorer". "Fact Explorer" is
...
// is a property of the workspace, and it now lives in one place every page can reach, the
